...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_page1_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "page1\0on_pushButton_clicked\0"
};
...
const QMetaObject page1::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_page1.data,
      qt_meta_data_page1,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *page1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_page1.stringdata))
        return static_cast<void*>(const_cast< page1*>(this));
